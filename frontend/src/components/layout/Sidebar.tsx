    ...
    <>
      ...
      >
        ...
        <div className="p-3 border-t border-[#e2e8f0] space-y-3">
          ...
          {/* User Profile Avatar Card (Clickable to open User Details Panel) */}
          <div 
          ...
          >
            ...
            <ChevronRight className="w-4 h-4 text-[#64748b] group-hover/user:text-[#1d4ed8] opacity-0 group-hover:opacity-100 transition-all duration-300 pr-2 shrink-0 group-hover/user:translate-x-0.5" />
          </div>
        </div>
      </aside>
